...
CREATE TABLE pelanggan (
    ...
    alamat_pelanggan CHAR(50) NOT NULL,
    pegawai_id       INTEGER
)
LOGGING;

ALTER TABLE pelanggan ADD CONSTRAINT pelanggan_pk PRIMARY KEY ( id );
...
CREATE TABLE pemesanan (
    ...
    nama_pesanan             VARCHAR2(50) NOT NULL,
...
ALTER TABLE barang
    ADD CONSTRAINT barang_pelanggan_fk FOREIGN KEY ( pelanggan_id )
...
ALTER TABLE pembayaran
    ADD CONSTRAINT pembayaran_pemesanan_fk FOREIGN KEY ( pemesanan_no_pesanan )
...
ALTER TABLE pemesanan
    ADD CONSTRAINT pemesanan_pembayaran_fk FOREIGN KEY ( pembayaran_id_pembayaran )
